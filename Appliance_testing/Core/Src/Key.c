...
{
	osEventFlagsSet(myEvent01Handle, SWITCH_TOGGLE_EVEN);
}

void BTN1_DOUBLE_Click_Handler(void* btn)//双击回调函数
{
	memset(ESP8266_DataStruct.esp8266_id, 0, sizeof(ESP8266_DataStruct.esp8266_id));
	memset(ESP8266_DataStruct.esp8266_pass, 0, sizeof(ESP8266_DataStruct.esp8266_pass));
	strncpy(ESP8266_DataStruct.esp8266_id,"NULL",4);
	strncpy(ESP8266_DataStruct.esp8266_pass,"NULL",4);
