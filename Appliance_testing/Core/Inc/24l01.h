...
#define NRF24L01_SPI_CS_ENABLE()    HAL_GPIO_WritePin(CS2_GPIO_Port,CSN_Pin,GPIO_PIN_RESET)
#define NRF24L01_SPI_CS_DISABLE()   HAL_GPIO_WritePin(CS2_GPIO_Port,CSN_Pin,GPIO_PIN_SET)
 
#define NRF24L01_CE_LOW()   HAL_GPIO_WritePin(CSN_GPIO_Port,CS2_Pin,GPIO_PIN_RESET)
#define NRF24L01_CE_HIGH() HAL_GPIO_WritePin(CSN_GPIO_Port,CS2_Pin,GPIO_PIN_SET)
 
#define NRF24L01_IRQ_PIN_READ()  HAL_GPIO_ReadPin(IQR_GPIO_Port,IQR_Pin)
